  ...
  if (restaurants.length === 0) {
    return (
      <div className="flex flex-col items-center">
        <div className="w-full max-w-[340px] aspect-square mx-auto flex items-center justify-center">
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <button
        ...
        className="mt-6 w-full max-w-[340px] mx-auto block py-4 px-8 rounded-2xl text-xl font-bold text-white bg-blue-500 hover:bg-blue-600 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
      >
        돌리기!
      </button>
    </div>
